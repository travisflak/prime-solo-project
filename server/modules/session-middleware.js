...
module.exports = cookieSession({
  ...
  maxAge: 60 * 60 * 1000, // Set to 1 hour - 60 min/hour * 60 s/min * 1000 ms/s (this may need to be changed for testing, you may need to lengthen or shorten duration times)
  secure: false
});
